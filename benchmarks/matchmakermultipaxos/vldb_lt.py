...
def main(args) -> None:
    class LatencyThroughputSuite(MatchmakerMultiPaxosSuite):
        ...
        def summary(self, input: Input, output: Output) -> str:
            return str({
                'f': input.f,
                'thrifty': input.leader_options.thrifty,
    ...
    suite = LatencyThroughputSuite()
    with benchmark.SuiteDirectory(
            args.suite_directory,
            'matchmaker_multipaxos_latency_throughput') as dir:
        suite.run_suite(dir)
