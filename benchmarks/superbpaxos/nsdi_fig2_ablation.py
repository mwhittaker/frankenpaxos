...
def main(args) -> None:
    class NsdiFig1AblationSuperBPaxosSuite(SuperBPaxosSuite):
        def args(self) -> Dict[Any, Any]:
            return vars(args)

        # TODO(mwhittaker): Figure out a good set of parameters.
        # TODO(mwhittaker): Add nsdi_fig2_ablation in simple bpaxos.
        # TODO(mwhittaker): Make sure this actually runs at all.
    ...
    suite = NsdiFig1AblationSuperBPaxosSuite()
