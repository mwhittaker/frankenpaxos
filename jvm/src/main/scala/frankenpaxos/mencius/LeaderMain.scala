...
object LeaderMain extends App {
  ...
  val parser = new scopt.OptionParser[Flags]("") {
    ...
    // Options.
    opt[Int]("options.sendHighWatermarkEveryN")
      .optionAction((x, o) => o.copy(sendHighWatermarkEveryN = x))
    opt[Int]("options.sendNoopRangeIfLaggingBy")
      .optionAction((x, o) => o.copy(sendNoopRangeIfLaggingBy = x))
  ...
  val leader = new Leader[NettyTcpTransport](
    address = config.leaderAddresses(flags.groupIndex)(flags.index),
