...
def main(args) -> None:
    class EuroSysLtMultiPaxosSuite(MultiPaxosSuite):
        ...
        def inputs(self) -> Collection[Input]:
            return [
                ...
                for (
                    ...
                    ( 1,   1, 0, 10, 3, 5, 10, 0, 1, 1, 1),
                    ( 1,  10, 0, 10, 3, 5, 10, 0, 5, 1, 1),
                    ( 5,  10, 0, 10, 3, 5, 10, 0, 10, 1, 1),
                    ( 5,  20, 0, 10, 3, 5, 10, 0, 10, 1, 1),
                    ( 6,  50, 0, 10, 3, 5, 10, 0, 25, 1, 1),
                    ( 6, 100, 0, 10, 3, 5, 10, 0, 100, 10, 1),
                    (10, 100, 0, 10, 3, 5, 10, 0, 100, 10, 1),
    ...
    suite = EuroSysLtMultiPaxosSuite()
    with benchmark.SuiteDirectory(args.suite_directory,
                                  'multipaxos_eurosys_lt') as dir:
        suite.run_suite(dir)
