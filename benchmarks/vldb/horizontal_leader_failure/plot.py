...
def plot(n1: pd.DataFrame,
    ...
    failure = \
        datetime.datetime(2020, 6, 23, hour=16, minute=8, second=2, microsecond=857000)
    recover = \
        datetime.datetime(2020, 6, 23, hour=16, minute=8, second=6, microsecond=894000)
...
def main(args) -> None:
    ...
    (f1n4, _) = read_data(args.f1n4, args.drop_head, args.drop_tail,
                          nudge=datetime.timedelta(milliseconds=250))
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--output',
                        type=str,
                        default='horizontal_leader_failure.pdf',
