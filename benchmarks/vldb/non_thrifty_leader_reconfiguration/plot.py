...
def plot(n1: pd.DataFrame,
    ...
    reconfigurations = [
        datetime.datetime(2020, 6, 28, hour=18, minute=10, second=36, microsecond=229000),
        datetime.datetime(2020, 6, 28, hour=18, minute=10, second=37, microsecond=231000),
        datetime.datetime(2020, 6, 28, hour=18, minute=10, second=38, microsecond=233000),
        datetime.datetime(2020, 6, 28, hour=18, minute=10, second=39, microsecond=235000),
        datetime.datetime(2020, 6, 28, hour=18, minute=10, second=40, microsecond=236000),
        datetime.datetime(2020, 6, 28, hour=18, minute=10, second=41, microsecond=238000),
        datetime.datetime(2020, 6, 28, hour=18, minute=10, second=42, microsecond=240000),
        datetime.datetime(2020, 6, 28, hour=18, minute=10, second=43, microsecond=242000),
        datetime.datetime(2020, 6, 28, hour=18, minute=10, second=44, microsecond=243000),
        datetime.datetime(2020, 6, 28, hour=18, minute=10, second=45, microsecond=246000),
    ]
    failure = datetime.datetime(2020, 6, 28, hour=18, minute=10, second=50, microsecond=224000)
    recover = datetime.datetime(2020, 6, 28, hour=18, minute=10, second=55, microsecond=223000)
...
def main(args) -> None:
    ...
    (f1n4, _) = read_data(args.f1n4, args.drop_head, args.drop_tail + 10)
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--output',
                        type=str,
                        default='non_thrifty_leader_reconfiguration.pdf',
