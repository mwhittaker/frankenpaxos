...
def plot(n1: pd.DataFrame,
    ...
    reconfigurations = [
        datetime.datetime(2020, 7, 2, hour=18, minute=51, second=4, microsecond=304000),
        datetime.datetime(2020, 7, 2, hour=18, minute=51, second=5, microsecond=306000),
        datetime.datetime(2020, 7, 2, hour=18, minute=51, second=6, microsecond=308000),
        datetime.datetime(2020, 7, 2, hour=18, minute=51, second=7, microsecond=310000),
        datetime.datetime(2020, 7, 2, hour=18, minute=51, second=8, microsecond=312000),
        datetime.datetime(2020, 7, 2, hour=18, minute=51, second=9, microsecond=313000),
        datetime.datetime(2020, 7, 2, hour=18, minute=51, second=10, microsecond=315000),
        datetime.datetime(2020, 7, 2, hour=18, minute=51, second=11, microsecond=317000),
        datetime.datetime(2020, 7, 2, hour=18, minute=51, second=12, microsecond=319000),
        datetime.datetime(2020, 7, 2, hour=18, minute=51, second=13, microsecond=321000),
    ]
    failure = datetime.datetime(2020, 7, 2, hour=18, minute=51, second=18, microsecond=298000)
    recover = datetime.datetime(2020, 7, 2, hour=18, minute=51, second=23, microsecond=298000)
